...
class show_cart_shop extends StatefulWidget {
  ...
  show_cart_shop( this.title, this.image_1,this.id,this.price);
...
class _DetailPageState extends State<show_cart_shop>
      ...
      child: SizedBox(
          ...
          child: AspectRatio(
            ...
            child: Container(
              ...
              child: Image.network(title['image_1']),
            ),
          ),
        )),
        SizedBox(width: 20),
        ...
        child: Column(
          ...
          children: [
            ...
            Text.rich(
              TextSpan(
                text: "\ ${formatter.format(int.parse(title['specs'][5]))} ",
                style: TextStyle(
                    fontWeight: FontWeight.w600, color: kPrimaryColor),
                children: [
                  TextSpan(
                      text: "x ${title['specs'][6]}",
